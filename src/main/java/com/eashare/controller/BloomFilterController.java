...
import com.eashare.utils.BloomFilterUtil;
...
public class BloomFilterController {
    ...
    public Result getStats() {
        ...
        return Result.ok(Collections.singletonMap("elementCount", count));
    }
    ...
    public Result contains(@PathVariable Long id) {
        ...
        return Result.ok(Collections.singletonMap("mightExist", exists));
    }
    ...
    public Result add(@PathVariable Long id) {
        ...
        return Result.ok(Collections.singletonMap("success", success));
    }
